export const topics = [
  ...
  },
  {
    ...
    img: "/images/health_wellness.jpg",
    contents: [
      {
        id: "hw1",
        title:
    ...
    contents: [
      {
        id: "te1",
        title:
          "Revolutionary Lightweight Microscope Captures Mice Brain Activity",
      },
      {
        id: "te2",
        title:
...
export const contents = [
  ...
  },
  {
    ...
    title:
      "Study Confirms 'Forever Chemicals' Can Be Absorbed Through Human Skin",
    content: `A recent study published in Environment International reveals for the first time that perfluoroalkyl substances (PFAS), widely used for their water and stain repellent properties, can permeate human skin and enter the bloodstream. This discovery challenges the previous assumption that the ionized nature of these 'forever chemicals' prevented them from crossing the skin barrier. Dr. Oddný Ragnarsdóttir, the lead researcher from the University of Birmingham, found that out of 17 PFAS tested, 15 demonstrated significant dermal absorption, with shorter-chain PFAS being absorbed more readily than their longer-chain counterparts.

    This comprehensive study used 3D human skin models to mimic normal skin properties, showing that even the most regulated PFAS like perfluorooctanoic acid (PFOA) had notable absorption rates. Co-author Dr. Mohamed Abdallah highlighted the importance of recognizing skin exposure as a significant route for PFAS uptake, urging further research on the risks associated with a broad range of these chemicals. Professor Stuart Harrad emphasized the need for greater understanding of how different chemical structures impact skin absorption, especially as industries move towards using shorter-chain PFAS.`,
  },
  {
    id: "ac1",
    title: "Enhancing Protein Music with Classical Melodies",
